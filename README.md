...
坐標標注的不只是某字（之後之位置），而是某字、某片段、某句、某行，甚至某幾行、組詩中的某首。「岱宗」之坐標是〚0003:3.1.1-2〛， 「齊魯青未了」之坐標是〚0003:3.2.1-5〛，「青未了」之坐標是〚0003:3.2.3-5〛，而「了」字之坐標是 〚0003:3.2.5〛。只要注文內容有清楚之界限，相應坐標就可以清楚地標明所屬。要自動編纂杜詩詞典，此步絕不可少。
