...
<h2>杜注本之還原</h2>
<p>基底正文樹、後設資料標記可支持某杜注本之還原，卽此注本原書之生成。此模式最大之優點：同一基底正文樹，結合不同版本之原始資料、後設資料，可生成無數之版本，亦可同時展示、幷列不同版本之資料。限於版權問題，只提供不受版權保護之原始資料及其後設資料。受保護之注本，如蕭滌非主編《杜甫全集校注》，則單提供後設資料。</p>
