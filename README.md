...
不管是古注本所用之夾注，還是現代注本所用之數字碼，均有一個格式上之限制：除非重覆杜詩原文，否則無法清楚顯示注文所屬。試考慮以下例子：
...
坐標標注的不是某字（之後之位置），而是某字、某片段、某句、某行，甚至某幾行、組詩中的某首。「岱宗」之坐標是〚0003:3.1.1-2〛， 「齊魯青未了」之坐標是〚0003:3.2.1-5〛，「青未了」之坐標是〚0003:3.2.3-5〛，而「了」字之坐標是 〚0003:3.2.5〛。只要注文內容有清楚之界限，相應坐標就可以清楚地標明所屬。
