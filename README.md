...
- 生成注本：如何在不儲存個別注本原來文本之前提下，生成幷顯示某注本的原書原貌（<a href="https://github.com/wingmingchan64/CanonicalTextTrees/blob/main/corpus/dufu/杜詩鏡詮/views/0097.html">《杜詩鏡詮》之《自京赴奉先縣詠懷五百字》</a> HTML，<a href="https://github.com/wingmingchan64/CanonicalTextTrees/blob/main/corpus/dufu/杜詩鏡詮/views/0097.pdf">《杜詩鏡詮》之《自京赴奉先縣詠懷五百字》 PDF</a>）
...
**重要信息：** 我正在重新設計、建立後設資料單元，後設資料樹是最新的槪念。這部分正處於「動蕩期」（2026/05/12）。我一直在跟 ChatGPT 討論後設資料的設計，這種「動蕩」是我們之間的討論的具體反映。
